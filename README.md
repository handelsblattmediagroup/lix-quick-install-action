...
[![ci/cd pipeline static](https://img.shields.io/github/actions/workflow/status/handelsblattmediagroup/lix-quick-install-action/cicd.yml)](https://github.com/handelsblattmediagroup/lix-quick-install-action/actions/workflows/cicd.yml) [![latest release](https://img.shields.io/github/v/release/handelsblattmediagroup/lix-quick-install-action)](https://github.com/handelsblattmediagroup/lix-quick-install-action/releases/latest) ![trans rights](https://pride-badges.pony.workers.dev/static/v1?label=trans%20rights&stripeWidth=6&stripeColors=5BCEFA,F5A9B8,FFFFFF,F5A9B8,5BCEFA)
...
```
<<<<<<< HEAD
$ nix run -f https://github.com/handelsblattmediagroup/lix-quick-install-action/archive/refs/heads/main.zip lixVersions.v2_93_3 -- --version
nix (Lix, like Nix) 2.93.3
=======
$ nix run -f https://github.com/canidae-solutions/lix-quick-install-action/archive/refs/heads/main.zip lixVersions.v2_95_2 -- --version
...
```
$ nix build -f https://github.com/handelsblattmediagroup/lix-quick-install-action/archive/refs/heads/v1.zip lixVersions.v2_90_0
